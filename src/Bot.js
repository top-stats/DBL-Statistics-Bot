...
class Bot extends Base {
  constructor (base) {
    ...
    app.get('/api/access/:role/:id', async (req, res) => {
      ...
      const guild = this.client.guilds.get('264445053596991498')
      ...
      if (!guild.members.get(id)) { if (!foundMember) return res.status(404).json({ code: 404, message: 'Member not found' })}
